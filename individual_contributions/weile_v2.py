...
def main():
    ...
    print_quantity_based_summary(list(zip(unique_product_values, sum_of_quantity_for_products)))

    print("Total revenue for each product")
    print_revenue_based_summary(list(zip(unique_product_values, total_revenue_for_products)))
    ...
    print_revenue_based_summary(list(zip(unique_city_values, total_revenue_for_cities)))

    print("Average monthly revenue for each branch location (city)")
    print_revenue_based_summary(list(zip(unique_city_values, average_monthly_revenue_for_cities)))
    ...
    print_revenue_based_summary(list(zip(unique_manager_values, total_revenue_for_manager)))
    ...
    print_revenue_based_summary(sorted(zip(unique_month_values_from_date, total_revenue_by_month), key=lambda x: x[0]))
